...
class RationaliseTheDenominatorHardLevel {
    constructor() {
        this.key = 'rationaliseTheDenominatorHard';
...
window.AlgebraLevels.rationaliseTheDenominatorHard = new RationaliseTheDenominatorHardLevel();