...
class FactoriseMonicQuadraticTrinomialsEasyLevel {
    constructor() {
        this.key = 'factoriseMonicQuadraticTrinomialsEasy';
...
window.AlgebraLevels.factoriseMonicQuadraticTrinomialsEasy = new FactoriseMonicQuadraticTrinomialsEasyLevel();