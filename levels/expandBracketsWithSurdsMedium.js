class ExpandBracketsWithSurdsMediumLevel {
    constructor() {
        this.key = 'expandBracketsWithSurdsMedium';
...
window.AlgebraLevels.expandBracketsWithSurdsMedium = new ExpandBracketsWithSurdsMediumLevel();