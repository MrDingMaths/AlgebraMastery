class ExpandBinomialProductsHardLevel {
    constructor() {
        this.key = 'expandBinomialProductsHard';
...
window.AlgebraLevels.expandBinomialProductsHard = new ExpandBinomialProductsHardLevel();