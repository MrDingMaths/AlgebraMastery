...
class RationaliseTheDenominatorMediumLevel {
    constructor() {
        this.key = 'rationaliseTheDenominatorMedium';
...
window.AlgebraLevels.rationaliseTheDenominatorMedium = new RationaliseTheDenominatorMediumLevel();