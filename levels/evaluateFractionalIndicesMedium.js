...
class EvaluateFractionalIndicesMediumLevel {
    constructor() {
        this.key = 'evaluateFractionalIndicesMedium';
...
window.AlgebraLevels.evaluateFractionalIndicesMedium = new EvaluateFractionalIndicesMediumLevel();