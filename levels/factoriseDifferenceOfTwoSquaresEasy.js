class FactoriseDifferenceOfTwoSquaresEasyLevel {
    constructor() {
        this.key = 'factoriseDifferenceOfTwoSquaresEasy';
...
window.AlgebraLevels.factoriseDifferenceOfTwoSquaresEasy = new FactoriseDifferenceOfTwoSquaresEasyLevel();