class FactorisePerfectSquaresHardLevel {
    constructor() {
        this.key = 'factorisePerfectSquaresHard';
...
window.AlgebraLevels.factorisePerfectSquaresHard = new FactorisePerfectSquaresHardLevel();