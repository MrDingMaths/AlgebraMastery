class PowerOfProductsAndQuotientsEasyLevel {
    constructor() {
        this.key = 'powerOfProductsAndQuotientsEasy';
...
window.AlgebraLevels.powerOfProductsAndQuotientsEasy = new PowerOfProductsAndQuotientsEasyLevel();