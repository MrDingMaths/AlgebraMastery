class SimplifyAlgebraicFractionsByFactorisingMediumLevel {
    constructor() {
        this.key = 'simplifyAlgebraicFractionsByFactorisingMedium';
        ...
        this.questions = [
            ...
            {problem: "\\frac{x^2+11x+30}{6x+30}", answer: "\\frac{x+6}{6}"},
            {problem: "\\frac{x^2-2x-24}{x^2+12x+32}", answer: "\\frac{x-6}{x+8}"},
...
window.AlgebraLevels.simplifyAlgebraicFractionsByFactorisingMedium = new SimplifyAlgebraicFractionsByFactorisingMediumLevel();