...
class MultiplicationIndexLawEasyLevel {
    constructor() {
        this.key = 'multiplicationIndexLawEasy';
...
window.AlgebraLevels.multiplicationIndexLawEasy = new MultiplicationIndexLawEasyLevel();