...
class RationaliseBinomialDenominatorEasyLevel {
    constructor() {
        this.key = 'rationaliseBinomialDenominatorEasy';
...
window.AlgebraLevels.rationaliseBinomialDenominatorEasy = new RationaliseBinomialDenominatorEasyLevel();