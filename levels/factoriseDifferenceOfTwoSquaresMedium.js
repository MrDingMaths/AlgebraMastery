class FactoriseDifferenceOfTwoSquaresMediumLevel {
    constructor() {
        this.key = 'factoriseDifferenceOfTwoSquaresMedium';
...
window.AlgebraLevels.factoriseDifferenceOfTwoSquaresMedium = new FactoriseDifferenceOfTwoSquaresMediumLevel();