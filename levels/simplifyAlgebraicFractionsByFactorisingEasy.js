class SimplifyAlgebraicFractionsByFactorisingEasyLevel {
    constructor() {
        this.key = 'simplifyAlgebraicFractionsByFactorisingEasy';
        ...
        this.questions = [
            ...
            {problem: "\\frac{6}{12x-18}", answer: "\\frac{1}{2x-3}"},
            ...
            {problem: "\\frac{12x}{80+2xy}", answer: "\\frac{6x}{40+xy}"},
...
window.AlgebraLevels.simplifyAlgebraicFractionsByFactorisingEasy = new SimplifyAlgebraicFractionsByFactorisingEasyLevel();