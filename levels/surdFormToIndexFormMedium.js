...
class SurdFormToIndexFormMediumLevel {
    constructor() {
        this.key = 'surdFormToIndexFormMedium';
...
window.AlgebraLevels.surdFormToIndexFormMedium = new SurdFormToIndexFormMediumLevel();