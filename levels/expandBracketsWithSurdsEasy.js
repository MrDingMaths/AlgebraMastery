class ExpandBracketsWithSurdsEasyLevel {
    constructor() {
        this.key = 'expandBracketsWithSurdsEasy';
...
window.AlgebraLevels.expandBracketsWithSurdsEasy = new ExpandBracketsWithSurdsEasyLevel();