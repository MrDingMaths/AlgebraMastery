class NoticeBinomialFactorsEasyLevel {
    constructor() {
        this.key = 'noticeBinomialFactorsEasy';
        ...
        this.questions = [
            ...
            {problem: "7(x - 3) + x(x - 3)", answer: "(x + 7)(x - 3)"},
            ...
            {problem: "x(2x + 5) + 3(2x + 5)", answer: "(x + 3)(2x + 5)"},
            ...
            {problem: "x(5x - 2) + 4(5x - 2)", answer: "(x + 4)(5x - 2)"},
            {problem: "3x(x + 1) + (x + 1)", answer: "(3x + 1)(x + 1)"},
            {problem: "2(a - 3) - x(a - 3) - y(a - 3)", answer: "(2 - x - y)(a - 3)"},
            ...
            {problem: "4(x - 1) - x(x - 1)", answer: "(4 - x)(x - 1)"},
            ...
            {problem: "2(x - 8) + x(x - 8)", answer: "(x + 2)(x - 8)"},
...
window.AlgebraLevels.noticeBinomialFactorsEasy = new NoticeBinomialFactorsEasyLevel();