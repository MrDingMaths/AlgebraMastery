...
class FactoriseNonMonicQuadraticTrinomialsMediumLevel {
    constructor() {
        this.key = 'factoriseNonMonicQuadraticTrinomialsMedium';
...
window.AlgebraLevels.factoriseNonMonicQuadraticTrinomialsMedium = new FactoriseNonMonicQuadraticTrinomialsMediumLevel();