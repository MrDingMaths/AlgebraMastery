...
class FinishFactorisingMedium {
    constructor() {
        ...
        this.questions = [
            ...
            {problem: "16x^2 - 40x + 25", answer: "(4x - 5)^2"},
            {problem: "(49 - x^2)(x + 7)", answer: "(7 - x)(x + 7)^2"},
            {problem: "6(y + 3)(2y^2 + 12y + 18)", answer: "12(y + 3)^3"},
            {problem: "(x + 8)(x^2 + 10x + 25)", answer: "(x + 8)(x + 5)^2"},
            {problem: "x^2 + 24x + 144", answer: "(x + 12)^2"},
            {problem: "25x^2 - 60x + 36", answer: "(5x - 6)^2"},
            {problem: "(36 - x^2)(x + 6)", answer: "(6 - x)(x + 6)^2"},
            {problem: "8(x + 4)(x^2 + 8x + 16)", answer: "8(x + 4)^3"},
            {problem: "(x + 9)(x^2 + 12x + 36)", answer: "(x + 9)(x + 6)^2"},
            {problem: "x^2 + 26x + 169", answer: "(x + 13)^2"},
            {problem: "36x^2 - 84x + 49", answer: "(6x - 7)^2"},
            {problem: "(64 - x^2)(x + 8)", answer: "(8 - x)(x + 8)^2"},
            {problem: "10(x + 5)(2x^2 + 20x + 50)", answer: "20(x + 5)^3"},
            {problem: "(x + 10)(x^2 + 14x + 49)", answer: "(x + 10)(x + 7)^2"},
            {problem: "x^2 + 28x + 196", answer: "(x + 14)^2"},
            {problem: "49x^2 - 126x + 81", answer: "(7x - 9)^2"},
            {problem: "(81 - b^2)(b + 9)", answer: "(9 - b)(b + 9)^2"},
            {problem: "12(x + 6)(3x^2 + 36x + 108)", answer: "36(x + 6)^3"},
            {problem: "(x + 11)(x^2 + 16x + 64)", answer: "(x + 11)(x + 8)^2"},
            {problem: "x^2 + 30x + 225", answer: "(x + 15)^2"},
            {problem: "64x^2 - 176x + 121", answer: "(8x - 11)^2"},
            {problem: "(100 - x^2)(x + 10)", answer: "(10 - x)(x + 10)^2"}
        ];
    }
