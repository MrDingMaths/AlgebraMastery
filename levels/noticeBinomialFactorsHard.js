class NoticeBinomialFactorsHardLevel {
    constructor() {
        this.key = 'noticeBinomialFactorsHard';
...
window.AlgebraLevels.noticeBinomialFactorsHard = new NoticeBinomialFactorsHardLevel();