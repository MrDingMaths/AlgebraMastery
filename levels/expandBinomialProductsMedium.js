class ExpandBinomialProductsMediumLevel {
    constructor() {
        this.key = 'expandBinomialProductsMedium';
...
window.AlgebraLevels.expandBinomialProductsMedium = new ExpandBinomialProductsMediumLevel();