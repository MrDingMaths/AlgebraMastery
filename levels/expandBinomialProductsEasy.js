class ExpandBinomialProductsEasyLevel {
    constructor() {
        this.key = 'expandBinomialProductsEasy';
...
window.AlgebraLevels.expandBinomialProductsEasy = new ExpandBinomialProductsEasyLevel();