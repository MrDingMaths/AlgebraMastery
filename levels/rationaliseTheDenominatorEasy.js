...
class RationaliseTheDenominatorEasyLevel {
    constructor() {
        this.key = 'rationaliseTheDenominatorEasy';
...
window.AlgebraLevels.rationaliseTheDenominatorEasy = new RationaliseTheDenominatorEasyLevel();