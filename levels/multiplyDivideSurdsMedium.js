class MultiplyDivideSurdsMediumLevel {
    constructor() {
        this.key = 'multiplyDivideSurdsMedium';
...
window.AlgebraLevels.multiplyDivideSurdsMedium = new MultiplyDivideSurdsMediumLevel();