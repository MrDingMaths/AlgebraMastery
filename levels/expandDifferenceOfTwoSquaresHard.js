class ExpandDifferenceOfTwoSquaresHardLevel {
    constructor() {
        this.key = 'expandDifferenceOfTwoSquaresHard';
...
window.AlgebraLevels.expandDifferenceOfTwoSquaresHard = new ExpandDifferenceOfTwoSquaresHardLevel();