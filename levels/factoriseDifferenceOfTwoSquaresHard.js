class FactoriseDifferenceOfTwoSquaresHardLevel {
    constructor() {
        this.key = 'factoriseDifferenceOfTwoSquaresHard';
...
window.AlgebraLevels.factoriseDifferenceOfTwoSquaresHard = new FactoriseDifferenceOfTwoSquaresHardLevel();