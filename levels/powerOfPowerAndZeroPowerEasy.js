...
class PowerOfPowerAndZeroPowerEasyLevel {
    constructor() {
        this.key = 'powerOfPowerAndZeroPowerEasy';
...
window.AlgebraLevels.powerOfPowerAndZeroPowerEasy = new PowerOfPowerAndZeroPowerEasyLevel();