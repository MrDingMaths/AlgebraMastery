...
class RationaliseBinomialDenominatorHardLevel {
    constructor() {
        this.key = 'rationaliseBinomialDenominatorHard';
...
window.AlgebraLevels.rationaliseBinomialDenominatorHard = new RationaliseBinomialDenominatorHardLevel();