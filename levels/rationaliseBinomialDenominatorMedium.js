...
class RationaliseBinomialDenominatorMediumLevel {
    constructor() {
        this.key = 'rationaliseBinomialDenominatorMedium';
...
window.AlgebraLevels.rationaliseBinomialDenominatorMedium = new RationaliseBinomialDenominatorMediumLevel();