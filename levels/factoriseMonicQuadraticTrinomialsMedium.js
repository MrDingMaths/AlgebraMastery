...
class FactoriseMonicQuadraticTrinomialsMediumLevel {
    constructor() {
        this.key = 'factoriseMonicQuadraticTrinomialsMedium';
...
window.AlgebraLevels.factoriseMonicQuadraticTrinomialsMedium = new FactoriseMonicQuadraticTrinomialsMediumLevel();