...
class FactoriseNonMonicQuadraticTrinomialsEasyLevel {
    constructor() {
        this.key = 'factoriseNonMonicQuadraticTrinomialsEasy';
...
window.AlgebraLevels.factoriseNonMonicQuadraticTrinomialsEasy = new FactoriseNonMonicQuadraticTrinomialsEasyLevel();