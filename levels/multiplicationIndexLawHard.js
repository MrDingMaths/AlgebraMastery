...
class MultiplicationIndexLawHardLevel {
    constructor() {
        this.key = 'multiplicationIndexLawHard';
...
window.AlgebraLevels.multiplicationIndexLawHard = new MultiplicationIndexLawHardLevel();