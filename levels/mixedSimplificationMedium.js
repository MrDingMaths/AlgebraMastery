...
class MixedSimplificationMediumLevel {
    constructor() {
        this.key = 'mixedSimplificationMedium';
...
window.AlgebraLevels.mixedSimplificationMedium = new MixedSimplificationMediumLevel();