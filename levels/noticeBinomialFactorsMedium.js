class NoticeBinomialFactorsMediumLevel {
    constructor() {
        this.key = 'noticeBinomialFactorsMedium';
...
window.AlgebraLevels.noticeBinomialFactorsMedium = new NoticeBinomialFactorsMediumLevel();