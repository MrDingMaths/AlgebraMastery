...
class PowerOfPowerAndZeroPowerMediumLevel {
    constructor() {
        this.key = 'powerOfPowerAndZeroPowerMedium';
...
window.AlgebraLevels.powerOfPowerAndZeroPowerMedium = new PowerOfPowerAndZeroPowerMediumLevel();