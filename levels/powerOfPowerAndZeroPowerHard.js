...
class PowerOfPowerAndZeroPowerHardLevel {
    constructor() {
        this.key = 'powerOfPowerAndZeroPowerHard';
...
window.AlgebraLevels.powerOfPowerAndZeroPowerHard = new PowerOfPowerAndZeroPowerHardLevel();