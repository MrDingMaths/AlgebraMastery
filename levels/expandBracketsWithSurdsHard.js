class ExpandBracketsWithSurdsHardLevel {
    constructor() {
        this.key = 'expandBracketsWithSurdsHard';
...
window.AlgebraLevels.expandBracketsWithSurdsHard = new ExpandBracketsWithSurdsHardLevel();