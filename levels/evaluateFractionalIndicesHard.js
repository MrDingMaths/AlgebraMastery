...
class EvaluateFractionalIndicesHardLevel {
    constructor() {
        this.key = 'evaluateFractionalIndicesHard';
...
window.AlgebraLevels.evaluateFractionalIndicesHard = new EvaluateFractionalIndicesHardLevel();